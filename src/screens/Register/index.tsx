...
import { InputForm } from '../../components/Form/imputForm';
...
const schema = Yup.object().shape({
    ...
    amount: Yup.number().typeError('Informe um valor numérico').positive('O valor não pode ser negativo').required('O valor é obrigatóro')
})
    ...
    function handleCloseSelectCategoryModal(){
     ...
     async function handleRegister(form: FormData){
        ...
        try {
            ...
            console.log('Variavel currentData ' + (currentData))
            ...
            console.log('Variavel dataFormated ' + dataFormatted)
